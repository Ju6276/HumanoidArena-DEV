...
class RealTimePolicyController:
    def __init__(self, 
        ...
        print("=== MuJoCo joint order (qpos/qvel) ===")
        jnt_qposadr = self.model.jnt_qposadr  # start index in qpos for each joint
        for j in range(self.model.njnt):
            name = mujoco.mj_id2name(self.model, mujoco.mjtObj.mjOBJ_JOINT, j)
            adr = jnt_qposadr[j]
            print(f"joint_id={j:3d} qpos_adr={adr:4d} name={name}")

        print("\n=== MuJoCo actuator order (ctrl) ===")
        for a in range(self.model.nu):
            name = mujoco.mj_id2name(self.model, mujoco.mjtObj.mjOBJ_ACTUATOR, a)
            print(f"act_id={a:3d} name={name}")
        #=== MuJoCo joint order (qpos/qvel) ===
        # joint_id=  0 qpos_adr=   0 name=pelvis
        # joint_id=  1 qpos_adr=   7 name=left_hip_pitch_joint
        # joint_id=  2 qpos_adr=   8 name=left_hip_roll_joint
        # joint_id=  3 qpos_adr=   9 name=left_hip_yaw_joint
        # joint_id=  4 qpos_adr=  10 name=left_knee_joint
        # joint_id=  5 qpos_adr=  11 name=left_ankle_pitch_joint
        # joint_id=  6 qpos_adr=  12 name=left_ankle_roll_joint
        # joint_id=  7 qpos_adr=  13 name=right_hip_pitch_joint
        # joint_id=  8 qpos_adr=  14 name=right_hip_roll_joint
        # joint_id=  9 qpos_adr=  15 name=right_hip_yaw_joint
        # joint_id= 10 qpos_adr=  16 name=right_knee_joint
        # joint_id= 11 qpos_adr=  17 name=right_ankle_pitch_joint
        # joint_id= 12 qpos_adr=  18 name=right_ankle_roll_joint
        # joint_id= 13 qpos_adr=  19 name=waist_yaw_joint
        # joint_id= 14 qpos_adr=  20 name=waist_roll_joint
        # joint_id= 15 qpos_adr=  21 name=waist_pitch_joint
        # joint_id= 16 qpos_adr=  22 name=left_shoulder_pitch_joint
        # joint_id= 17 qpos_adr=  23 name=left_shoulder_roll_joint
        # joint_id= 18 qpos_adr=  24 name=left_shoulder_yaw_joint
        # joint_id= 19 qpos_adr=  25 name=left_elbow_joint
        # joint_id= 20 qpos_adr=  26 name=left_wrist_roll_joint
        # joint_id= 21 qpos_adr=  27 name=left_wrist_pitch_joint
        # joint_id= 22 qpos_adr=  28 name=left_wrist_yaw_joint
        # joint_id= 23 qpos_adr=  29 name=right_shoulder_pitch_joint
        # joint_id= 24 qpos_adr=  30 name=right_shoulder_roll_joint
        # joint_id= 25 qpos_adr=  31 name=right_shoulder_yaw_joint
        # joint_id= 26 qpos_adr=  32 name=right_elbow_joint
        # joint_id= 27 qpos_adr=  33 name=right_wrist_roll_joint
        # joint_id= 28 qpos_adr=  34 name=right_wrist_pitch_joint
        # joint_id= 29 qpos_adr=  35 name=right_wrist_yaw_joint
        #
        # === MuJoCo actuator order (ctrl) ===
        # act_id=  0 name=left_hip_pitch_joint
        # act_id=  1 name=left_hip_roll_joint
        # act_id=  2 name=left_hip_yaw_joint
        # act_id=  3 name=left_knee_joint
        # act_id=  4 name=left_ankle_pitch_joint
        # act_id=  5 name=left_ankle_roll_joint
        # act_id=  6 name=right_hip_pitch_joint
        # act_id=  7 name=right_hip_roll_joint
        # act_id=  8 name=right_hip_yaw_joint
        # act_id=  9 name=right_knee_joint
        # act_id= 10 name=right_ankle_pitch_joint
        # act_id= 11 name=right_ankle_roll_joint
        # act_id= 12 name=waist_yaw_joint
        # act_id= 13 name=waist_roll_joint
        # act_id= 14 name=waist_pitch_joint
        # act_id= 15 name=left_shoulder_pitch_joint
        # act_id= 16 name=left_shoulder_roll_joint
        # act_id= 17 name=left_shoulder_yaw_joint
        # act_id= 18 name=left_elbow_joint
        # act_id= 19 name=left_wrist_roll_joint
        # act_id= 20 name=left_wrist_pitch_joint
        # act_id= 21 name=left_wrist_yaw_joint
        # act_id= 22 name=right_shoulder_pitch_joint
        # act_id= 23 name=right_shoulder_roll_joint
        # act_id= 24 name=right_shoulder_yaw_joint
        # act_id= 25 name=right_elbow_joint
        # act_id= 26 name=right_wrist_roll_joint
        # act_id= 27 name=right_wrist_pitch_joint
        # act_id= 28 name=right_wrist_yaw_joint
        # sim_decimation: 10.0
        # TWIST2 Controller Configura
        ...
        self.stiffness = np.array([
            ...
            # 100., 100., 150., 100., 100., 150., 100., 100., 150., 150., 150., 40.,
        ...
        self.damping = np.array([
            ...
            # 2.0000, 2.0000, 4.0000, 2.0000, 2.0000, 4.0000, 2.0000, 2.0000, 4.0000,
