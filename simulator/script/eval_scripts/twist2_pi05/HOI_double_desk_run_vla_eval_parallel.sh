...
ENV_CONFIG_YAML="${ENV_CONFIG_YAML:-tasks/common_test_config/base_test/doubledesk_twist2_test.yaml}"
...
TWIST2_MODEL_PATH="${TWIST2_MODEL_PATH:-${ISAACLAB_ROOT}/../external/TWIST2/assets/ckpts/twist2_1017_20k.onnx}"
...
RESULTS_TAG_BASE="${RESULTS_TAG:-1test_HOI_double_desk_twist2_batch_2000_mix}"
