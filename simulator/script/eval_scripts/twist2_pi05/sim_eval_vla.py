...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--env_config_yaml", type=str, default="tasks/common_test_config/base_test/football_single_twist2_test.yaml", help="YAML file with env config overrides")
...
def _normalize_control_routing(args):
    ...
    args.gmt_backend = "twist2"
    args.action_source = "twist2_wholebody"
