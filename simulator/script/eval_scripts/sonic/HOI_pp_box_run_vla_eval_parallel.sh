...
export ENV_CONFIG_YAML="${ENV_CONFIG_YAML:-tasks/common_test_config/base_test/pp_box_sonic_test.yaml}"
RESULTS_TAG_BASE="${RESULTS_TAG:-1test_HOI_pp_box_sonic_batch_2000_mix}"
