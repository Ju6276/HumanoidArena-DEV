...
@configclass
class PickPlaceSmallTrolleySceneCfg(InteractiveSceneCfg): # inherit from the interactive scene configuration class
    """Small trolley pick-place scene configuration."""
...
DoubleTableSceneCfg = PickPlaceSmallTrolleySceneCfg
