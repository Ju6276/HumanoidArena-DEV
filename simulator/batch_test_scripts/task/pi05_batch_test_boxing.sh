...
ENV_CONFIG_YAML="${SONIC_CONFIG}"   run_task sonic "${ISAACLAB_ROOT}/script/eval_scripts/sonic_pi05/HSI_boxing_run_vla_eval_parallel.sh"
ENV_CONFIG_YAML="${TWIST2_CONFIG}"  run_task twist2 "${ISAACLAB_ROOT}/script/eval_scripts/twist2_pi05/HSI_boxing_run_vla_eval_parallel.sh"
